      ...
      <div className="max-w-4xl mx-auto px-4 py-14">
        ...
        <div className="space-y-8 text-slate-700 leading-relaxed">
          ...
          <Section title="9. Privacy">
            <p>Your use of this Website is also governed by our <Link href="/privacy"><a className="text-amber-600 hover:underline font-semibold">Privacy Policy</a></Link>, which is incorporated into these Terms by reference. Please review our Privacy Policy to understand our practices.</p>
          </Section>
